...
int main() {
...

	{
		...
		int row0[] = { 2 }, row1[] = { 3, 4 }, row2[] = { 6, 5, 7 }, row3[] = {
				4, 1, 8, 3 };
...
//      382 LinkedListRandom
		...
		cout << solution.getRandom() << " " << solution.getRandom() << " "
				<< solution.getRandom() << endl;
	}

	{
//	  383_ransomNote
		cout << "Ransom note ('aa', 'aba'): " << canConstruct("aa", "aba")
				<< endl;
	}
...

	{
		...
		cout << "First unique char: " << firstUniqChar2("loveleetcode") << " | "
				<< firstUniqChar("leetcode") << endl;
	}
